                    ...
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form className="space-y-4 md:space-y-6" action="#">
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <a href="#" className="text-sm font-medium text-rose-600 hover:underline dark:text-primary-500">Forgot password?</a>
                            </div>
                            ...
                            <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                                Don’t have an account yet? <Link href="/registration" className="font-medium text-rose-600 hover:underline dark:text-primary-500">Sign up</Link>
                            </p>
                        </form>
                    </div>
                </div>
